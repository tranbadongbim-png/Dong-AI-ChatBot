...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        id="app-sidebar"
        className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-slate-200 bg-slate-50/95 transition-transform duration-300 ease-in-out dark:border-slate-800 dark:bg-slate-950/95 md:static md:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-200 p-4 dark:border-slate-800">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-blue-700 active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="ml-2 rounded-lg p-2 text-slate-500 hover:bg-slate-200/60 dark:text-slate-400 dark:hover:bg-slate-800 md:hidden"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="p-3">
          <div
            ...
            className={`rounded-xl border p-3 transition-all ${
              enableThinking
                ? "border-amber-400/50 bg-amber-500/10 dark:border-amber-500/30 dark:bg-amber-950/20"
          ...
          >
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-slate-600 dark:text-slate-400">
              {enableThinking
                ...
                : "Chuyển đổi sang chế độ suy luận sâu để giải quyết các truy vấn học thuật, coding và logic phức tạp nhất."}
            </p>
          </div>
        </div>
              ...
              return (
                <div
                  ...
                  className={`group relative flex cursor-pointer items-center justify-between rounded-xl px-3 py-2.5 text-xs transition-all ${
                    isActive
                      ? "bg-white font-medium text-blue-600 shadow-xs ring-1 ring-slate-200 dark:bg-slate-900 dark:text-blue-400 dark:ring-slate-800"
        ...
        <div className="border-t border-slate-200 p-3 dark:border-slate-800">
          <div className="flex items-center justify-between rounded-lg bg-slate-100/80 px-3 py-2 text-[11px] text-slate-600 dark:bg-slate-900/60 dark:text-slate-400">
            <span className="flex items-center gap-1.5 font-medium">
              <Zap className="h-3 w-3 text-blue-500" />
              Gemini 3.8 Core
            </span>
            <span className="rounded bg-slate-200/70 px-1.5 py-0.5 text-[10px] dark:bg-slate-800">
              v2.4.0 SDK
            </span>
          </div>
        </div>
